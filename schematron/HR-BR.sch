...
<schema xmlns="http://purl.oclc.org/dsdl/schematron"
  ...
  <pattern id="HR-Model">
    ...
    <rule context="/">
      <assert test="inv:Invoice or cn:CreditNote">
    ...
    <rule context="/inv:Invoice | /cn:CreditNote">
      ...
      <let name="sumLineExtensionAmount" value="sum((cac:InvoiceLine | cac:CreditNoteLine)/cbc:LineExtensionAmount)"/>
      <let name="sumDocumentLevelAllowance" value="sum(cac:AllowanceCharge[cbc:ChargeIndicator='false']/cbc:Amount)"/>
      <let name="sumDocumentLevelCharge" value="sum(cac:AllowanceCharge[cbc:ChargeIndicator='true']/cbc:Amount)"/>
      <let name="sumOutOfScopeLineAmount" value="sum((cac:InvoiceLine | cac:CreditNoteLine)[cac:Item/cac:ClassifiedTaxCategory/cbc:ID = ('O', 'E')]/cbc:LineExtensionAmount)"/>
      <let name="sumOutOfScopeAllowance" value="sum(cac:AllowanceCharge[cbc:ChargeIndicator='false' and cac:TaxCategory/cbc:ID = ('O', 'E')]/cbc:Amount)"/>
      <let name="sumOutOfScopeCharge" value="sum(cac:AllowanceCharge[cbc:ChargeIndicator='true' and cac:TaxCategory/cbc:ID = ('O', 'E')]/cbc:Amount)"/>
      <let name="sumInScopeLineAmount" value="sum((cac:InvoiceLine | cac:CreditNoteLine)[not(cac:Item/cac:ClassifiedTaxCategory/cbc:ID = ('O', 'E'))]/cbc:LineExtensionAmount)"/>
      <let name="sumInScopeAllowance" value="sum(cac:AllowanceCharge[cbc:ChargeIndicator='false' and not(cac:TaxCategory/cbc:ID = ('O', 'E'))]/cbc:Amount)"/>
      <let name="sumInScopeCharge" value="sum(cac:AllowanceCharge[cbc:ChargeIndicator='true' and not(cac:TaxCategory/cbc:ID = ('O', 'E'))]/cbc:Amount)"/>
      ...
      <assert id="HR-BR-5" flag="fatal"
              test="cbc:CustomizationID = 'urn:cen.eu:en16931:2017#compliant#urn:mfin.gov.hr:cius-2025:1.0#conformant#urn:mfin.gov.hr:ext-2025:1.0'">
      ...
      <assert id="HR-BR-6" flag="fatal"
              test="every $ref in cac:BillingReference satisfies ($ref/cac:InvoiceDocumentReference/cbc:IssueDate)">
      ...
      <assert id="HR-BR-11" flag="fatal"
              test="every $charge in cac:AllowanceCharge[cbc:ChargeIndicator='true'] satisfies (
                not($charge/cac:TaxCategory/cbc:ID = 'E') or
                $charge/cac:TaxCategory/cbc:Name = ('HR:E', 'HR:POVNAK', 'HR:PP', 'HR:PPMV', 'HR:N')
              )">
      ...
      <assert id="HR-BR-13" flag="fatal"
              test="every $charge in cac:AllowanceCharge[cbc:ChargeIndicator='true'] satisfies (
                not($charge/cac:TaxCategory/cbc:ID = 'E') or
                $charge/cac:TaxCategory/cbc:TaxExemptionReason or
                $charge/cac:TaxCategory/cbc:TaxExemptionReasonCode
              )">
      ...
      <assert id="HR-BR-17" flag="fatal"
              test="not((cac:InvoiceLine | cac:CreditNoteLine)/cac:OrderLineReference/cac:OrderReference/cbc:ID and cac:OrderReference/cbc:ID)">
      ...
      <assert id="HR-BR-18" flag="fatal"
              test="not((cac:InvoiceLine | cac:CreditNoteLine)/cac:DespatchLineReference/cac:DocumentReference/cbc:ID and cac:DespatchDocumentReference/cbc:ID)">
      ...
      <assert id="HR-BR-19" flag="fatal"
              test="not((cac:InvoiceLine | cac:CreditNoteLine)/cac:ReceiptLineReference/cac:DocumentReference/cbc:ID and cac:ReceiptDocumentReference/cbc:ID)">
      ...
      <assert id="HR-BR-25" flag="fatal"
              test="cbc:ProfileID = 'P4'
          or cbc:InvoiceTypeCode = '386'
          or not((cac:InvoiceLine | cac:CreditNoteLine)
                  [not(cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode)
                   or cac:Item/cac:CommodityClassification/cbc:ItemClassificationCode/@listID != 'CG'])">
      ...
      <assert id="HR-BR-26" flag="fatal"
              test="count(cac:TaxSubtotal[cac:TaxCategory/cbc:TaxExemptionReason or cac:TaxCategory/cbc:TaxExemptionReasonCode]) &lt;= count(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/hrextac:HRFISK20Data/hrextac:HRTaxTotal/hrextac:HRTaxSubtotal)">
      ...
      <!-- TODO: Nije jasno kako povezati TaxSubtotal i HRTaxSubtotal elemente jer element Name nije obvezan, ILI se ovdje misli na hrext:HRTaxScheme -->
      ...
      <!-- TODO: Što se tiče validacijske sheme, ovo pravilo vjerojatno samo znači da HR-BT-17 mora biti `0` ako je HR-BT-18 `O` (Out of scope), te da HR-BT-18 mora odgovarati vrijednosti iz HR-TB-2 -->
      <assert id="HR-BR-29" flag="fatal"
              test="every $hrSubtotal in ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/hrextac:HRFISK20Data/hrextac:HRTaxTotal/hrextac:HRTaxSubtotal satisfies (
                not($hrSubtotal/cac:TaxCategory/cbc:ID = 'O' and $hrSubtotal/cbc:TaxAmount != '0')
              )">
      ...
      <assert id="HR-BR-30" flag="fatal"
              test="not(
                (cac:InvoiceLine | cac:CreditNoteLine)/cac:Item/cac:ClassifiedTaxCategory/cbc:ID = ('O', 'E') or
                cac:AllowanceCharge/cac:TaxCategory/cbc:ID = ('O', 'E')
              ) or
                ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/hrextac:HRFISK20Data/hrextac:HRLegalMonetaryTotal">
      ...
      <assert id="HR-BR-31" flag="fatal"
              test="not(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/hrextac:HRFISK20Data/hrextac:HRLegalMonetaryTotal/hrextac:HRTaxExclusiveAmount) or
                   (ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/hrextac:HRFISK20Data/hrextac:HRLegalMonetaryTotal/hrextac:HRTaxExclusiveAmount =
                    ($sumInScopeLineAmount - $sumInScopeAllowance + $sumInScopeCharge -
      ...
      <assert id="HR-BR-32" flag="fatal"
              test="not(ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/hrextac:HRFISK20Data/hrextac:HRLegalMonetaryTotal/cbc:OutOfScopeOfVATAmount) or
                   (ext:UBLExtensions/ext:UBLExtension/ext:ExtensionContent/hrextac:HRFISK20Data/hrextac:HRLegalMonetaryTotal/cbc:OutOfScopeOfVATAmount =
                    ($sumOutOfScopeLineAmount - $sumOutOfScopeAllowance + $sumOutOfScopeCharge))">
      ...
      <assert id="HR-BR-37" flag="fatal"
              test="cac:AccountingSupplierParty/cac:SellerContact/cbc:Name">
    ...
    <rule context="/inv:Invoice/cac:InvoiceLine | /cn:CreditNote/cac:CreditNoteLine">
      ...
      <assert id="HR-BR-16" flag="fatal"
              test="not(cac:Item/cac:ClassifiedTaxCategory/cbc:ID = 'E') or
                    cac:Item/cac:ClassifiedTaxCategory/cbc:Name = ('HR:E', 'HR:POVNAK', 'HR:PP', 'HR:PPMV', 'HR:N')">
      ...
      <assert id="HR-BR-21" flag="fatal"
              test="not(cac:Price/cbc:BaseQuantity/@unitCode) or
                    ((cbc:InvoicedQuantity | cbc:CreditedQuantity)/@unitCode and
      ...
      <assert id="HR-BR-35" flag="fatal"
              test="not(cac:Item/cac:ClassifiedTaxCategory/cbc:ID = 'E') or
                    cac:Item/cac:ClassifiedTaxCategory/cbc:Percent = 0">
      ...
      <assert id="HR-BR-36" flag="fatal"
              test="not(cac:Item/cac:ClassifiedTaxCategory/cbc:ID = 'E') or
                    cac:Item/cac:ClassifiedTaxCategory/cbc:TaxExemptionReason or
                    cac:Item/cac:ClassifiedTaxCategory/cbc:TaxExemptionReasonCode">
