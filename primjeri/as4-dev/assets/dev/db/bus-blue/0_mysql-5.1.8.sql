...
--  *********************************************************************
--  Change Log: src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml
--  Ran at: 5/28/25, 7:08 PM
--  Against: null@offline:mysql?changeLogFile=target/liquibase/changelog-1.13.mysql
...
--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-7836::gautifr
...
--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog-quartz.xml::EDELIVERY-3425::migueti
...
--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-4740::idragusa
...
--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-2427::Francois Gautier
...
--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-7803-Dictionary Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-7803-UserMessage Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-7803-Miscellaneous Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-7803-PMode Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-7803-Alert Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-8450::Francois Gautier
...
--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-7803-Backend Filter Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-7803-User/Plugin User Tables::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-4669::dussath
...
--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-8503_1::ion perpegel
...
--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-8532::ion perpegel
...
--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-9563::Razvan Cretu
...
--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-9686::Lucian Furca
ALTER TABLE TB_PM_SECURITY ADD PROFILE VARCHAR(255) NULL;

--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-10091::Soumya Chandran 
...
--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-11509::idragusa
CREATE INDEX IDX_SIG_MESS_SIGNAL_MESS_ID ON TB_SIGNAL_MESSAGE(SIGNAL_MESSAGE_ID);

--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-12066::Cosmin Baciu
...
--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::12066-1::Cosmin Baciu
CREATE INDEX IDX_DDC_FINAL_RECIPIENT ON TB_DDC_LOOKUP(FINAL_RECIPIENT);

--  Changeset src/main/resources/db/releases/5.1.8/5.1.8-changelog.xml::EDELIVERY-11796-add-pks-mysql::Gabriel Maier
