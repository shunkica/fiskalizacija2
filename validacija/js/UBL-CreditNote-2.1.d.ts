...
// Schema TargetNamespace: urn:oasis:names:specification:ubl:schema:xsd:CreditNote-2

export type CreditNote = CreditNoteType;
...
export interface CreditNoteType {
  ...
  CreditNoteTypeCode?: cbc_CreditNoteTypeCodeType;
  ...
  DiscrepancyResponse?: cac_ResponseType | cac_ResponseType[];
  ...
  CreditNoteLine: cac_CreditNoteLineType | cac_CreditNoteLineType[];
}
...
export interface cac_CreditNoteLineType {
  ID: cbc_IDType;
  UUID?: cbc_UUIDType;
  Note?: cbc_NoteType | cbc_NoteType[];
  CreditedQuantity?: cbc_CreditedQuantityType;
  ...
  Price?: cac_PriceType;
  DeliveryTerms?: cac_DeliveryTermsType | cac_DeliveryTermsType[];
  SubCreditNoteLine?: cac_CreditNoteLineType | cac_CreditNoteLineType[];
...
export interface cac_ResponseType {
  ReferenceID?: cbc_ReferenceIDType;
  ResponseCode?: cbc_ResponseCodeType;
  Description?: cbc_DescriptionType | cbc_DescriptionType[];
  EffectiveDate?: cbc_EffectiveDateType;
  EffectiveTime?: cbc_EffectiveTimeType;
  Status?: cac_StatusType | cac_StatusType[];
}
...
export type cbc_CreditNoteTypeCodeType = udt_CodeType;

export type cbc_CreditedQuantityType = udt_QuantityType;
...
export type cbc_EffectiveDateType = udt_DateType;

export type cbc_EffectiveTimeType = udt_TimeType;
...
export type cbc_ReferenceIDType = udt_IdentifierType;
...
export type cbc_ResponseCodeType = udt_CodeType;
